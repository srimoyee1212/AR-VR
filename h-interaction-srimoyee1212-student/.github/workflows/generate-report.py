...
student_assignment = 'interaction'
...
def cleanupStringForLatex(studentWriteup):
...
latex.write('\n')
latex.write(cleanupStringForLatex(student_writeup))
latex.write('\n')
...
for testName in testNames:
  latex.write(cleanupStringForLatex(testName) + '\\\\')
  latex.write('\n')
...
for resultSummary in resultsSummaryList:
  latex.write(cleanupStringForLatex(resultSummary) + '\\\\')
  latex.write('\n')
